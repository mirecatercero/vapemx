...
$videohead = '
            ...
            <div class="header-content text-md-center">
              <p>
                VapeMX tiene como misión ayudar a las personas a dejar el habito de fumar, mediante un vapeador. Nuestra prioridad siempre es la satisfacción del cliente, por lo que nos hemos encargado de tener los mejores productos para que disfrutes y dejes de una vez por todas el tabaco.
              </p>
              <a class="btn-video" href="localhost/wordpress/blog">Visita el blog para apreder.</a>
            </div>
          </div>';
