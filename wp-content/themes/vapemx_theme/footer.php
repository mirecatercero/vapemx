...
<footer id="footer" itemscope="itemscope" itemtype="http://schema.org/WPFooter">
	...
	<div class="container">
		...
		if ( ! empty( $zerif_socials_facebook ) || ! empty( $zerif_socials_twitter ) || ! empty( $zerif_socials_linkedin ) || ! empty( $zerif_socials_behance ) || ! empty( $zerif_socials_dribbble ) ||
			...
			echo '<div class="zerif-copyright-box"><a class="zerif-copyright" rel="nofollow">VapeMX  </a>' . sprintf( __( 'desarollado por %s', 'zerif-lite' ), '<a class="zerif-copyright" href="' . esc_url( 'https://themeisle.com' ) . '" ' . $attribut_new_tab . ' rel="nofollow">' . __( 'Insight', 'zerif-lite' ) . '</a>' ) . '</div>';
